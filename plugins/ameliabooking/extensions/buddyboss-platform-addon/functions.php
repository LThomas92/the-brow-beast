...
if (! function_exists('convertUserRoles')) {
     ...
     */
    function convertUserRoles($signup_ids, $result)
    {
        if (Amelia_transform_users_enabled()) {
            $args  = array(
                'role'    => 'subscriber',
                'include' => $result['activated']
            );
            ...
            createCustomers($signup_ids, $result);
        }
    }

}
add_action('bp_core_signup_after_activate', 'convertUserRoles', 10, 2);
...
if (! function_exists('createCustomers')) {
     ...
     * @throws QueryExecutionException
     */
    function createCustomers($signup_ids, $result)
    {
        $args  = array(
...
//add_action('bp_core_signup_after_activate', 'createCustomers', 10, 2);
