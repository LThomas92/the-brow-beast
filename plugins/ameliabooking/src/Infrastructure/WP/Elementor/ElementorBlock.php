...
class ElementorBlock
{
    ...
    {
        $this->includes();
        Plugin::instance()->widgets_manager->register_widget_type(new AmeliaStepBookingElementorWidget());
        Plugin::instance()->widgets_manager->register_widget_type(new AmeliaCatalogBookingElementorWidget());
