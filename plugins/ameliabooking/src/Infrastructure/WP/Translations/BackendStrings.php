...
class BackendStrings
{
    ...
    public static function getCommonStrings()
    {
        return [
            ...
            'customize_dialog_heading'           => __('New Catalog 2.0 Booking Form', 'wpamelia'),
            'customize_dialog_sub_heading'       => __('We introduce you totally new, modernized Catalog 2.0 Booking form. Check it out and try new customize options on our Customize page or add <strong>[ameliacatalogbooking]</strong> shortcode to the page for a faster look!', 'wpamelia'),
            ...
            'customize_dialog_go_to'             => __('Go to the Customize Catalog 2.0 page', 'wpamelia'),
            'customize_dialog_check'             => __('Check it out Catalog 2.0', 'wpamelia'),
...
%company_name%'),
            ...
            'whatsapp_notice_header'                 => __('The message header needs to be set on the Facebook Developers Settings', 'wpamelia'),
