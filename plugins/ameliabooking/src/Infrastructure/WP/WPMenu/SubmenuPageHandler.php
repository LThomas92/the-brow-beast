...
class SubmenuPageHandler
{
    ...
    private function renderOld($page)
    {
        ...
        if ($page === 'wpamelia-locations' || $page === 'wpamelia-settings' || $page === 'wpamelia-events' || $page === 'wpamelia-appointments'
            || $page === 'wpamelia-dashboard' || $page === 'wpamelia-calendar') {
    ...
    private function renderNew($page)
    {
        ...
        if (AMELIA_DEV) {
            ...
            wp_enqueue_script(
                $scriptId,
                AMELIA_URL . 'v3/public/assets/admin.aa64137d.js',
                [],
                AMELIA_VERSION,
                true
            );
